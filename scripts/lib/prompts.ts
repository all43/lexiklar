...
const GLOSS_INTRO: string = `You are a German-English translator for a bilingual dictionary.`;
 ...
 */
export const WORD_SYSTEM_PROMPT: string = `${GLOSS_INTRO}
 ...
 */
export const WORD_SYSTEM_PROMPT_BATCH: string = `${GLOSS_INTRO}
 ...
 */
export const WORD_SYSTEM_PROMPT_BATCH_IDS: string = `${GLOSS_INTRO}
 ...
 */
export const PHRASE_SYSTEM_PROMPT: string = `${GLOSS_INTRO}
 ...
 */
export const SYSTEM_PROMPT_FULL: string = `${GLOSS_INTRO}
 ...
 */
export const EXAMPLES_SYSTEM_PROMPT: string = `You are a German-English translation assistant for a dictionary app targeting B2 learners.
...
/** JSON schema describing the expected shape of TRANSLATIONS_SCHEMA responses. */
interface TranslationsSchemaType {
  ...
  readonly required: readonly ["translations"];
 ...
 */
export const TRANSLATIONS_SCHEMA: TranslationsSchemaType = {
  type: "object",
  properties: {
    translations: {
      type: "array",
 ...
 */
export const WORD_SYSTEM_PROMPT_BATCH_PLAIN: string = `${GLOSS_INTRO}
...
export const SYSTEM_PROMPT: string = WORD_SYSTEM_PROMPT;
