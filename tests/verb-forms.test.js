...
describe("computeConjugation", () => {
  ...
  describe("weak verbs", () => {
    it("machen — basic weak conjugation", () => {
      const conj = computeConjugation(loadVerb("machen"), endings);
    ...
    it("erinnern — -ern stem adjustments", () => {
      const conj = computeConjugation(loadVerb("erinnern"), endings);
    ...
    it("arbeiten — -t stem with e-insertion", () => {
      const conj = computeConjugation(loadVerb("arbeiten"), endings);
  ...
  describe("strong verbs", () => {
    it("laufen — a→äu vowel change in present du/er", () => {
      const conj = computeConjugation(loadVerb("laufen"), endings);
    ...
    it("geben — e→i vowel change with imperative override", () => {
      const conj = computeConjugation(loadVerb("geben"), endings);
    ...
    it("fahren — a→ä in present but NOT in imperative", () => {
      const conj = computeConjugation(loadVerb("fahren"), endings);
    ...
    it("finden — -d stem with e-insertion (strong verb)", () => {
      const conj = computeConjugation(loadVerb("finden"), endings);
    ...
    it("gehen — strong verb with irregular past stem", () => {
      const conj = computeConjugation(loadVerb("gehen"), endings);
  ...
  describe("separable verbs", () => {
    it("ankommen — prefix separated in conjugated forms", () => {
      const conj = computeConjugation(loadVerb("ankommen"), endings);
    ...
    it("aufheben — prefix separated correctly", () => {
      const conj = computeConjugation(loadVerb("aufheben"), endings);
  ...
  describe("mixed verbs", () => {
    it("denken — changed stem + weak preterite endings", () => {
      const conj = computeConjugation(loadVerb("denken"), endings);
  ...
  describe("irregular verbs", () => {
    it("sein — returns stored conjugation unchanged", () => {
      const conj = computeConjugation(loadVerb("sein"), endings);
    ...
    it("haben — returns stored conjugation unchanged", () => {
      const conj = computeConjugation(loadVerb("haben"), endings);
...
describe("computeAllForms", () => {
  it("returns a Set", () => {
    const forms = computeAllForms(loadVerb("machen"), endings);
  ...
  it("ankommen — includes both separated and rejoined forms", () => {
    const forms = computeAllForms(loadVerb("ankommen"), endings);
  ...
  it("sein — irregular forms from stored table", () => {
    const forms = computeAllForms(loadVerb("sein"), endings);
  ...
  it("all forms are lowercase", () => {
    const forms = computeAllForms(loadVerb("laufen"), endings);
