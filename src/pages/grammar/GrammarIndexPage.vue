<template>
  <f7-page name="grammar-index">
    ...
    <f7-list inset strong-ios outline-ios>
      ...
      <f7-list-item link="/grammar/noun-gender/"          :title="t('grammar.nounGenderRules')" />
      ...
      <f7-list-item link="/grammar/proadverb/"            :title="t('grammar.proadverb')" />
    </f7-list>
  </f7-page>
</template>
