...
const locales: Record<LocaleKey, TranslationMap> = {
  en: {
    ...
    "word.oscillatingNoteSep": "\u21C4 Also inseparable:",
    "word.oscillatingNoteInsep": "\u21C4 Also separable:",
    ...
    "grammar.oscillatingVerbs": "Dual-prefix verbs",
    "grammar.oscillatingVerbsTitle": "Dual-Prefix Verbs",
    "grammar.oscillatingVerbsDesc": "Some prefixes (durch-, über-, um-, unter-, hinter-, wieder-) can be either separable or inseparable, giving the verb two distinct meanings. Stress tells them apart: a stressed prefix splits off in main clauses and adds ge- in Partizip II; an unstressed prefix stays fused with the verb and never adds ge-.",
    "grammar.oscillatingVerbsRules": "How to tell them apart",
    "grammar.oscillatingVerbsSep": "separable (stressed prefix, adds ge-)",
    "grammar.oscillatingVerbsInsep": "inseparable (unstressed prefix, no ge-)",
    ...
    "grammar.allVerbPrepositions": "All verb prepositions \u2192",
    "grammar.fullReference": "Full reference \u2192",
    "grammar.allDeterminerParadigms": "All determiner paradigms \u2192",
    "grammar.konjunktivOverview": "Konjunktiv overview \u2192",
    "grammar.connectors": "Connectors",
    "grammar.connectorsTitle": "Connectors",
    "grammar.connectorsDesc": "German connectors link clauses but differ in word order. Coordinating conjunctions keep verb-2 order; subordinating conjunctions push the verb to the end; adverbial connectors cause subject-verb inversion.",
    "grammar.connectorsWordOrder": "Word order patterns",
    "grammar.connectorsCoord": "Coordinating",
    "grammar.connectorsSub": "Subordinating",
    "grammar.connectorsAdv": "Adverbial",
    "grammar.connectorsPrep": "Prep.",
    "grammar.connectorsWordOrderCoordRule": "Verb stays in position 2",
    "grammar.connectorsWordOrderSubRule": "Verb moves to end of clause",
    "grammar.connectorsWordOrderAdvRule": "Subject and verb invert",
    "grammar.connectorsCause": "Cause",
    "grammar.connectorsConsequence": "Consequence",
    "grammar.connectorsConcession": "Concession",
    "grammar.connectorsNämlich": "Watch out: n\u00e4mlich",
    "grammar.connectorsNämlichDesc": "n\u00e4mlich introduces the reason (like weil), not the consequence \u2014 and it cannot stand at position 1.",
    "grammar.connectorsFormal": "formal",
    "grammar.casesListView": "List",
    "grammar.casesDiagramView": "Diagram",
    "grammar.connectorsByMeaning": "By meaning",
    "grammar.connectorsByType": "By type",
    "grammar.connectorsMeaningCause": "cause",
    "grammar.connectorsMeaningConsequence": "consequence",
    "grammar.connectorsMeaningConcession": "concession",
    "grammar.proadverb": "Pronominal adverbs (da-/wo-)",
    "grammar.proadverbTitle": "Pronominaladverbien",
    "grammar.proadverbDesc": "Da-compounds replace preposition + it/that for things and ideas. Wo-compounds are the question form. They cannot refer to people \u2014 use preposition + pronoun instead.",
    "grammar.proadverbHowItWorks": "How it works",
    "grammar.proadverbDaDesc": "Replaces preposition + pronoun for things \u2014 with it, about that, for it",
    "grammar.proadverbWoDesc": "Question form \u2014 with what?, about what?, for what?",
    "grammar.proadverbRInsertion": "-r- insertion",
    "grammar.proadverbRInsertionDesc": "When the preposition starts with a vowel, -r- is inserted for pronunciation",
    "grammar.proadverbPeopleVsThings": "Things vs. people",
    "grammar.proadverbThings": "Things / ideas",
    "grammar.proadverbPeople": "People",
    "grammar.proadverbTable": "All forms",
    "grammar.proadverbCommonVerbs": "Common verb + da-compound pairs",
    "grammar.purposeClauses": "Purpose clauses (um…zu & damit)",
    "grammar.purposeClausesTitle": "Purpose Clauses",
    "grammar.purposeClausesDesc": "Purpose clauses express why someone does something — the goal or intention behind an action. German uses two main constructions: um…zu (infinitive) and damit (subordinate clause).",
    "grammar.purposeClausesStructure": "Structure",
    "grammar.purposeClausesSepVerb": "With separable verbs, zu is inserted between the prefix and stem:",
    "grammar.purposeClausesRule": "When to use which?",
    "grammar.purposeClausesSameSubject": "Same subject in both clauses",
    "grammar.purposeClausesDiffSubject": "Different subjects",
    "grammar.purposeClausesSameSubjectNote": "When both clauses have the same subject, both forms are correct — but um…zu is preferred because it's shorter:",
    "grammar.purposeClausesCommonVerbs": "Common verbs with zu + Infinitiv",
    "grammar.purposeClausesMistakes": "Common mistakes",
    "grammar.purposeClausesMistake1": "Same subject → prefer um…zu (shorter, more natural).",
    "grammar.purposeClausesMistake2": "Don't forget um — zu alone is not enough for a purpose clause.",
    "grammar.purposeClausesMistake3": "damit = subordinate clause → verb goes to the end.",
    "grammar.verbPrepositions": "Verbs with fixed prepositions",
    "grammar.verbPrepositionsTitle": "Verben mit festen Präpositionen",
    "grammar.verbPrepositionsDesc": "Many German verbs always pair with a specific preposition that governs a fixed case. These combinations must be memorized — the preposition often doesn't translate literally from English.",
    "grammar.vpHowItWorks": "How it works",
    "grammar.vpHowItWorksDesc": "The preposition is fixed for each verb meaning and always takes the same case. Some verbs combine multiple prepositions for different roles (person + topic).",
    "grammar.vpDualPreps": "Different preposition = different meaning",
    "grammar.vpDualPrepsDesc": "Some verbs change meaning entirely depending on which preposition they pair with:",
    "grammar.vpSeeAlso": "See also",
    "grammar.vpProadverbHint": "da-/wo- compounds replace preposition + pronoun when referring to things",
    "grammar.vpCasesHint": "Overview of which prepositions take which case",
    "grammar.tenses": "Tenses",
    "grammar.tensesTitle": "German Tenses",
    "grammar.tensesDesc": "German has six main tenses. Compound tenses are formed with haben or sein as auxiliary verb.",
    "grammar.tensesWeak": "weak",
    "grammar.tensesStrong": "strong",
    "grammar.tensesIrregular": "irregular",
    "grammar.tensesAuxNote": "Auxiliary: most verbs use haben. Verbs of motion or change of state (fahren, gehen, werden…) use sein.",
    "grammar.tensesPrasensFormation": "Present stem + personal ending: <strong>-e, -st, -t, -en, -t, -en</strong>. Strong verbs change the stem vowel in 2nd/3rd person singular.",
    "grammar.tensesPrasensUsage": "Current actions, habits, general truths, and near future with a time expression (morgen, nächste Woche).",
    "grammar.tensesPreteritumFormation": "Weak verbs: stem + <strong>-te(n)</strong>. Strong verbs: vowel change in the stem, no <strong>-te</strong> ending.",
    "grammar.tensesPreteritumUsage": "Narrative past in writing (novels, news). haben, sein, and modal verbs commonly use it in speech too.",
    "grammar.tensesPerfektFormation": "<strong>haben/sein</strong> (present) + <strong>Partizip II</strong>. Verbs of motion and change of state take sein; most others take haben.",
    "grammar.tensesPerfektUsage": "The standard way to talk about past events in conversation.",
    "grammar.tensesPlusquamperfektFormation": "<strong>haben/sein</strong> (preterite) + <strong>Partizip II</strong>.",
    "grammar.tensesPlusquamperfektUsage": "Past-before-past — what was already completed before another past event.",
    "grammar.tensesFutur1Formation": "<strong>werden</strong> (present) + infinitive. Often replaced by present tense + time expression in spoken German.",
    "grammar.tensesFutur1Usage": "Predictions, intentions, and assumptions about the present ('Er wird schlafen' = He's probably sleeping).",
    "grammar.tensesFutur2Formation": "<strong>werden</strong> (present) + <strong>Partizip II</strong> + <strong>haben/sein</strong>.",
    "grammar.tensesFutur2Usage": "Completed future or assumptions about the past ('Er wird es gemacht haben' = He has probably done it).",
    "grammar.konjunktiv": "Konjunktiv (subjunctive)",
    "grammar.konjunktivTitle": "Konjunktiv I & II",
    "grammar.konjunktivDesc": "German has two subjunctive moods. Konjunktiv II expresses unreal conditions, wishes, and polite requests. Konjunktiv I is used primarily for indirect speech.",
    "grammar.konj2Purpose": "Unreal conditions, wishes, polite requests",
    "grammar.konj1Purpose": "Indirect / reported speech",
    "grammar.konj2Desc": "Konjunktiv II describes situations that are not real — hypothetical scenarios, wishes, and polite requests. In everyday speech, würde + infinitive often replaces the synthetic forms.",
    "grammar.konj2Formation": "Formation",
    "grammar.konj2FormationNote": "Derived from the <strong>Präteritum</strong> stem. Strong verbs add umlaut where possible. Auxiliary verbs, modals, and common strong verbs use the synthetic form; most other verbs use <strong>würde</strong> + infinitive.",
    "grammar.konj2Wuerde": "würde + Infinitiv",
    "grammar.konj2WuerdeNote": "The <strong>würde</strong>-form replaces synthetic Konjunktiv II for most regular verbs. Avoid it with <strong>hätte</strong>, <strong>wäre</strong>, and modal verbs — their synthetic forms are standard.",
    "grammar.konj2Common": "Common synthetic forms",
    "grammar.konj2CommonNote": "These frequent verbs sound more natural in the synthetic form. For most other verbs, use <strong>würde</strong> + infinitive.",
    "grammar.konj2Usage": "Usage",
    "grammar.konj2UsageUnreal": "Unreal conditions (wenn …)",
    "grammar.konj2UsagePolite": "Polite requests",
    "grammar.konj2UsageWish": "Wishes",
    "grammar.konj2UsageAdvice": "Suggestions / advice",
    "grammar.konj1Desc": "Konjunktiv I is used to report what someone else said without expressing your own opinion. It is most common in news, formal writing, and fixed expressions.",
    "grammar.konj1Formation": "Formation",
    "grammar.konj1FormationNote": "Derived from the <strong>infinitive</strong> stem. Add subjunctive endings: <strong>-e, -est, -e, -en, -et, -en</strong>. Only <strong>sein</strong> is fully distinct from the indicative in all persons.",
    "grammar.konj1Replacement": "When K1 = Indikativ",
    "grammar.konj1ReplacementNote": "When Konjunktiv I forms are identical to the indicative (common in 1st person singular and all plural forms), use <strong>Konjunktiv II</strong> instead to keep the subjunctive meaning clear.",
    "grammar.konj1UseK2": "Use K2",
    "grammar.konj1Usage": "Usage",
    "grammar.konj1UsageSpeech": "Indirect speech",
    "grammar.konj1UsageNews": "News / formal reports",
    "grammar.konj1UsageFixed": "Fixed expressions",
  },
  de: {
    // Tab bar
    "tab.search": "Suche",
    ...
    "word.oscillatingNoteSep": "\u21C4 Auch untrennbar:",
    "word.oscillatingNoteInsep": "\u21C4 Auch trennbar:",
    ...
    "grammar.oscillatingVerbs": "Wechselpr\u00e4fixverben",
    "grammar.oscillatingVerbsTitle": "Wechselpr\u00e4fixverben",
    "grammar.oscillatingVerbsDesc": "Bestimmte Pr\u00e4fixe (durch-, \u00fcber-, um-, unter-, hinter-, wieder-) k\u00f6nnen trennbar oder untrennbar sein und verleihen dem Verb dadurch zwei verschiedene Bedeutungen. Der Akzent unterscheidet sie: Ein betontes Pr\u00e4fix wird im Hauptsatz abgetrennt und bildet das Partizip II mit ge-; ein unbetontes Pr\u00e4fix bleibt stets verbunden und f\u00fcgt kein ge- ein.",
    "grammar.oscillatingVerbsRules": "Unterscheidung",
    "grammar.oscillatingVerbsSep": "trennbar (betontes Pr\u00e4fix, mit ge-)",
    "grammar.oscillatingVerbsInsep": "untrennbar (unbetontes Pr\u00e4fix, ohne ge-)",
    ...
    "grammar.allVerbPrepositions": "Alle Verb-Pr\u00e4positionen \u2192",
    "grammar.fullReference": "Vollst\u00e4ndige Referenz \u2192",
    "grammar.allDeterminerParadigms": "Alle Deklinationsparadigmen \u2192",
    "grammar.konjunktivOverview": "Konjunktiv-\u00dcbersicht \u2192",
    "grammar.connectors": "Konnektoren",
    "grammar.connectorsTitle": "Konnektoren",
    "grammar.connectorsDesc": "Deutsche Konnektoren verkn\u00fcpfen S\u00e4tze, unterscheiden sich aber in der Wortstellung. Nebenordnende Konjunktionen behalten die Verb-2-Stellung; unterordnende schieben das Verb ans Satzende; adverbiale Konnektoren bewirken eine Inversion.",
    "grammar.connectorsWordOrder": "Wortstellungsmuster",
    "grammar.connectorsCoord": "Nebenordnend",
    "grammar.connectorsSub": "Unterordnend",
    "grammar.connectorsAdv": "Adverbial",
    "grammar.connectorsPrep": "Pr\u00e4p.",
    "grammar.connectorsWordOrderCoordRule": "Verb bleibt auf Position 2",
    "grammar.connectorsWordOrderSubRule": "Verb ans Satzende",
    "grammar.connectorsWordOrderAdvRule": "Subjekt und Verb invertieren",
    "grammar.connectorsCause": "Ursache",
    "grammar.connectorsConsequence": "Folge",
    "grammar.connectorsConcession": "Einr\u00e4umung",
    "grammar.connectorsN\u00e4mlich": "Achtung: n\u00e4mlich",
    "grammar.connectorsN\u00e4mlichDesc": "n\u00e4mlich leitet den Grund ein (wie weil), nicht die Folge \u2014 und steht nie auf Position 1.",
    "grammar.connectorsFormal": "gehoben",
    "grammar.casesListView": "Liste",
    "grammar.casesDiagramView": "Diagramm",
    "grammar.connectorsByMeaning": "Nach Bedeutung",
    "grammar.connectorsByType": "Nach Typ",
    "grammar.connectorsMeaningCause": "Ursache",
    "grammar.connectorsMeaningConsequence": "Folge",
    "grammar.connectorsMeaningConcession": "Einräumung",
    "grammar.proadverb": "Pronominaladverbien (da-/wo-)",
    "grammar.proadverbTitle": "Pronominaladverbien",
    "grammar.proadverbDesc": "Da-Komposita ersetzen Pr\u00E4position + es/das f\u00FCr Sachen und Ideen. Wo-Komposita sind die Frageform. Sie k\u00F6nnen sich nicht auf Personen beziehen \u2014 dort steht Pr\u00E4position + Pronomen.",
    "grammar.proadverbHowItWorks": "So funktioniert es",
    "grammar.proadverbDaDesc": "Ersetzt Präposition + Pronomen für Sachen — damit, darüber, dafür",
    "grammar.proadverbWoDesc": "Frageform — womit?, worüber?, wofür?",
    "grammar.proadverbRInsertion": "-r-Einschub",
    "grammar.proadverbRInsertionDesc": "Beginnt die Präposition mit einem Vokal, wird -r- eingeschoben",
    "grammar.proadverbPeopleVsThings": "Sachen vs. Personen",
    "grammar.proadverbThings": "Sachen / Ideen",
    "grammar.proadverbPeople": "Personen",
    "grammar.proadverbTable": "Alle Formen",
    "grammar.proadverbCommonVerbs": "Häufige Verb + da-Komposita-Paare",
    "grammar.purposeClauses": "Finalsätze (um…zu & damit)",
    "grammar.purposeClausesTitle": "Finalsätze",
    "grammar.purposeClausesDesc": "Finalsätze drücken aus, warum jemand etwas tut — das Ziel oder die Absicht hinter einer Handlung. Im Deutschen gibt es zwei Hauptkonstruktionen: um…zu (Infinitiv) und damit (Nebensatz).",
    "grammar.purposeClausesStructure": "Struktur",
    "grammar.purposeClausesSepVerb": "Bei trennbaren Verben wird zu zwischen Vorsilbe und Stamm eingefügt:",
    "grammar.purposeClausesRule": "Wann welche Form?",
    "grammar.purposeClausesSameSubject": "Gleiches Subjekt in beiden Satzteilen",
    "grammar.purposeClausesDiffSubject": "Verschiedene Subjekte",
    "grammar.purposeClausesSameSubjectNote": "Wenn beide Satzteile das gleiche Subjekt haben, sind beide Formen korrekt — aber um…zu wird bevorzugt, weil es kürzer ist:",
    "grammar.purposeClausesCommonVerbs": "Häufige Verben mit zu + Infinitiv",
    "grammar.purposeClausesMistakes": "Häufige Fehler",
    "grammar.purposeClausesMistake1": "Gleiches Subjekt → um…zu bevorzugen (kürzer, natürlicher).",
    "grammar.purposeClausesMistake2": "um nicht vergessen — zu allein reicht nicht für einen Finalsatz.",
    "grammar.purposeClausesMistake3": "damit = Nebensatz → das Verb steht am Ende.",
    "grammar.verbPrepositions": "Verben mit festen Präpositionen",
    "grammar.verbPrepositionsTitle": "Verben mit festen Präpositionen",
    "grammar.verbPrepositionsDesc": "Viele deutsche Verben verbinden sich fest mit einer bestimmten Präposition, die einen festen Kasus regiert. Diese Verbindungen müssen auswendig gelernt werden — die Präposition lässt sich oft nicht wörtlich aus dem Englischen ableiten.",
    "grammar.vpHowItWorks": "So funktioniert es",
    "grammar.vpHowItWorksDesc": "Die Präposition ist für jede Verbbedeutung fest und nimmt immer denselben Kasus. Manche Verben kombinieren mehrere Präpositionen für verschiedene Rollen (Person + Thema).",
    "grammar.vpDualPreps": "Andere Präposition = andere Bedeutung",
    "grammar.vpDualPrepsDesc": "Manche Verben ändern ihre Bedeutung je nach Präposition vollständig:",
    "grammar.vpSeeAlso": "Siehe auch",
    "grammar.vpProadverbHint": "da-/wo-Komposita ersetzen Präposition + Pronomen bei Sachen",
    "grammar.vpCasesHint": "Übersicht, welche Präpositionen welchen Kasus regieren",
    "grammar.tenses": "Zeitformen",
    "grammar.tensesTitle": "Zeitformen",
    "grammar.tensesDesc": "Das Deutsche hat sechs Hauptzeitformen. Zusammengesetzte Zeiten werden mit haben oder sein als Hilfsverb gebildet.",
    "grammar.tensesWeak": "schwach",
    "grammar.tensesStrong": "stark",
    "grammar.tensesIrregular": "unregelmäßig",
    "grammar.tensesAuxNote": "Hilfsverb: Die meisten Verben verwenden haben. Bewegungsverben und Verben der Zustandsänderung (fahren, gehen, werden …) verwenden sein.",
    "grammar.tensesPrasensFormation": "Wortstamm + Personalendung: <strong>-e, -st, -t, -en, -t, -en</strong>. Starke Verben wechseln den Stammvokal in der 2./3. Person Sg.",
    "grammar.tensesPrasensUsage": "Aktuelle Handlungen, Gewohnheiten, allgemeine Wahrheiten und nahe Zukunft mit Zeitangabe (morgen, nächste Woche).",
    "grammar.tensesPreteritumFormation": "Schwache Verben: Stamm + <strong>-te(n)</strong>. Starke Verben: Vokalwechsel im Stamm, keine <strong>-te</strong>-Endung.",
    "grammar.tensesPreteritumUsage": "Erzählende Vergangenheit in der Schriftsprache. haben, sein und Modalverben werden auch im Gespräch im Präteritum verwendet.",
    "grammar.tensesPerfektFormation": "<strong>haben/sein</strong> (Präsens) + <strong>Partizip II</strong>. Bewegungsverben und Zustandsänderungen nehmen sein; die meisten anderen haben.",
    "grammar.tensesPerfektUsage": "Die übliche Form für vergangene Ereignisse im Gespräch.",
    "grammar.tensesPlusquamperfektFormation": "<strong>haben/sein</strong> (Präteritum) + <strong>Partizip II</strong>.",
    "grammar.tensesPlusquamperfektUsage": "Vorvergangenheit — was vor einem anderen vergangenen Ereignis bereits abgeschlossen war.",
    "grammar.tensesFutur1Formation": "<strong>werden</strong> (Präsens) + Infinitiv. Im gesprochenen Deutsch oft durch Präsens + Zeitangabe ersetzt.",
    "grammar.tensesFutur1Usage": "Vorhersagen, Absichten und Vermutungen über die Gegenwart ('Er wird schlafen' = Er schläft wahrscheinlich).",
    "grammar.tensesFutur2Formation": "<strong>werden</strong> (Präsens) + <strong>Partizip II</strong> + <strong>haben/sein</strong>.",
    "grammar.tensesFutur2Usage": "Abgeschlossene Zukunft oder Vermutungen über die Vergangenheit ('Er wird es gemacht haben' = Er hat es wahrscheinlich gemacht).",
    "grammar.konjunktiv": "Konjunktiv",
    "grammar.konjunktivTitle": "Konjunktiv I & II",
    "grammar.konjunktivDesc": "Das Deutsche hat zwei Konjunktivformen. Konjunktiv II drückt irreale Bedingungen, Wünsche und höfliche Bitten aus. Konjunktiv I wird vor allem für die indirekte Rede verwendet.",
    "grammar.konj2Purpose": "Irreale Bedingungen, Wünsche, höfliche Bitten",
    "grammar.konj1Purpose": "Indirekte Rede",
    "grammar.konj2Desc": "Konjunktiv II beschreibt Situationen, die nicht real sind — hypothetische Szenarien, Wünsche und höfliche Bitten. In der Alltagssprache ersetzt würde + Infinitiv oft die synthetischen Formen.",
    "grammar.konj2Formation": "Bildung",
    "grammar.konj2FormationNote": "Abgeleitet vom <strong>Präteritum</strong>-Stamm. Starke Verben erhalten einen Umlaut, wenn möglich. Hilfsverben, Modalverben und häufige starke Verben verwenden die synthetische Form; die meisten anderen Verben verwenden <strong>würde</strong> + Infinitiv.",
    "grammar.konj2Wuerde": "würde + Infinitiv",
    "grammar.konj2WuerdeNote": "Die <strong>würde</strong>-Form ersetzt den synthetischen Konjunktiv II bei den meisten regelmäßigen Verben. Bei <strong>hätte</strong>, <strong>wäre</strong> und Modalverben vermeiden — deren synthetische Formen sind Standard.",
    "grammar.konj2Common": "Häufige synthetische Formen",
    "grammar.konj2CommonNote": "Diese häufigen Verben klingen in der synthetischen Form natürlicher. Bei den meisten anderen Verben verwendet man <strong>würde</strong> + Infinitiv.",
    "grammar.konj2Usage": "Verwendung",
    "grammar.konj2UsageUnreal": "Irreale Bedingungen (wenn …)",
    "grammar.konj2UsagePolite": "Höfliche Bitten",
    "grammar.konj2UsageWish": "Wünsche",
    "grammar.konj2UsageAdvice": "Vorschläge / Ratschläge",
    "grammar.konj1Desc": "Konjunktiv I wird verwendet, um wiederzugeben, was jemand anderes gesagt hat, ohne die eigene Meinung auszudrücken. Er ist vor allem in Nachrichten, formeller Schriftsprache und festen Wendungen üblich.",
    "grammar.konj1Formation": "Bildung",
    "grammar.konj1FormationNote": "Abgeleitet vom <strong>Infinitiv</strong>-Stamm. Konjunktivendungen: <strong>-e, -est, -e, -en, -et, -en</strong>. Nur <strong>sein</strong> unterscheidet sich in allen Personen vom Indikativ.",
    "grammar.konj1Replacement": "Wenn K1 = Indikativ",
    "grammar.konj1ReplacementNote": "Wenn Konjunktiv-I-Formen mit dem Indikativ identisch sind (häufig in der 1. Person Singular und allen Pluralformen), wird stattdessen <strong>Konjunktiv II</strong> verwendet, um die konjunktivische Bedeutung deutlich zu machen.",
    "grammar.konj1UseK2": "K2 verwenden",
    "grammar.konj1Usage": "Verwendung",
    "grammar.konj1UsageSpeech": "Indirekte Rede",
    "grammar.konj1UsageNews": "Nachrichten / formelle Berichte",
    "grammar.konj1UsageFixed": "Feste Wendungen",
  },
};
